            ...
            <div className="p-8 bg-gradient-to-br from-indigo-600 to-blue-700 rounded-3xl text-white shadow-xl shadow-blue-900/40">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-white/10">
                  ...
                  <p className="text-[10px] mt-2 font-bold italic opacity-80">
                    {totalPoints >= (targetAward?.miles_required || 0) 
                      ? "READY TO BOOK: You have enough points for this route!" 
                      : `You need ${(targetAward?.miles_required || 0) - totalPoints} more miles.`}
                  </p>
                </div>
              </div>
            </div>
